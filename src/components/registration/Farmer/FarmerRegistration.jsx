          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8 ">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="flex cursor-pointer border-gray-400 border-solid border-2 rounded-lg bg-gray-100 items-center gap-2 justify-center">
                <div className="w-5 h-5">
                  <svg
                    className="eUuXwBkW5W4__eatjSfd RRXFBumaW2SHdseZaWm6 _gmxfZ2BpOHxa6nWwqBB g3OYBOqwXUEW4dRGogkH a0Ed69aMSu0vgf4oysz0"
                    viewBox="0 0 21 20"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <p className="mb-1">Sign up with Apple</p>
              </div>
